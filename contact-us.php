...
<body>
    ...
    <div class="contact-us-container">
        ...
        <div class="contact-us-section contact-us-section2">
            <h1>Address & Info</h1>
            <h3>Phone Numbers</h3>
            <p><a href="tel:01011391148">+91 010 11 39 11 48</a><br>
                <a href="tel:01011391148">+91 010 11 39 11 48</a></p>
            <h3>Address</h3>
            <p>El palitana</p>
            <h3>E-mail</h3>
            <p><a href="mailto:gujaratcinema@gmail.com">gujaratcinema@gmail.com</a></p>
        </div>
    </div>
    <!-- <div style="width: 75%; height: 350px; margin: 15%;"> -->
        <!-- <div class="gmap_canvas"><iframe id="gmap_canvas" src="https://maps.app.goo.gl/ki1BNu8y5XP3XUL27" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe> -->
        </div>
    </div>
    <footer></footer>
