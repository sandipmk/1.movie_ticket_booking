...
$order = "Gujarat chinema" . rand(10000, 99999999);
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if ($theatre == "main-hall") {
                                ...
                                die("<script>alert('Error: Ticket price cannot be zero. Please select a valid theatre.'); window.location.href='index.php';</script>");
                            }
...
$_SESSION["ta"] = $ta;
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                    <button value="Book Now!" type="submit" name="submit" class="btn btn-danger">Pay Now!</button>
